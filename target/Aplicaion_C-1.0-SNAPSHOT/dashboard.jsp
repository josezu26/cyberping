...
<div class="app">
  <div class="header">
    <div class="header-menu">
      <a class="menu-link is-active" href="#">CiberPing</a>
    </div>
    ...
    <div class="main-container">
      <div class="main-header" id="main_header">
        <div class="header-menu d-flex justify-content-center">
          <a class="main-header-link is-active" href="#">FORO</a>
          <a
            class="main-header-link rounded-circle"
            style="background: rgba(44, 62, 80, 0.5)"
            href="#"
            ><i class="fa-solid fa-camera" style="color: white"></i
          ></a>
          <a class="main-header-link" href="#">AVISOS</a>
        </div>
      </div>
